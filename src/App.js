...
function App() {
  ...
  function generatePDF() {
    let elementPDF = document.getElementById("previewPDF")
    html2pdf()
      .set({ margin: 10 })
      .from(elementPDF)
      .save()
  ...
  return (
    <div className="App">
      ...
      <label for='fundNameInput'>What is the fund's legal name?</label>
      <input type='text' onChange={fundNameHandler} id='companyNameInput'></input>
      <br></br>
      <br></br>

      <label for='companyNameInput'>What is the company's legal name?</label>
      <input type='text' onChange={companyNameHandler} id='companyNameInput'></input>
      <br></br>
      <br></br>
      ...
      <label for='corpTypeInput'>What kind of company is this?</label>
      <input type='text' onChange={corpTypeHandler} id='companyNameInput'></input>
      <br></br>
      <br></br>

      <label for='corpGeoInput'>Where is the Company incorporated?</label>
      <input type='text' onChange={corpGeoHandler} id='corpGeoInput'></input>
      <br></br>
      <br></br>

      <label for="invType">What type of investment is this?</label>
      ...
      <label for="actType">Is the company a Holdco or OpCo?</label>
      ...
      <button onClick={Export2Doc}>Download Word Doc</button>

      <div id='PreviewLetter' style={{ visibility: 'hidden' }}>
